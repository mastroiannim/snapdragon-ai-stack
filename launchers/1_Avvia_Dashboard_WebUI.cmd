...
if %errorlevel% equ 0 (
    ...
    echo.
    wsl -d Ubuntu bash -c "export DATA_DIR=$HOME/.open-webui; export PORT=8080; export WEBUI_AUTH=False; export ENABLE_OPENAI_API=True; export ENABLE_OLLAMA_API=False; export OPENAI_API_BASE_URLS=\"http://127.0.0.1:18182/v1;http://127.0.0.1:18187/v1;http://127.0.0.1:18188/v1;http://127.0.0.1:18189/v1;http://127.0.0.1:18185/v1;http://127.0.0.1:18181/v1;http://127.0.0.1:18186/v1;http://127.0.0.1:18184/v1;http://127.0.0.1:18183/v1\"; export OPENAI_API_KEYS=\"none;none;none;none;none;none;none;none;none\"; if [ -f $HOME/open-webui-env/bin/open-webui ]; then exec $HOME/open-webui-env/bin/open-webui serve; elif [ -f $HOME/.local/bin/open-webui ]; then exec $HOME/.local/bin/open-webui serve; elif command -v open-webui >/dev/null 2>&1; then exec open-webui serve; else echo '[ERRORE] Open-WebUI non trovato in WSL Ubuntu.'; echo 'Installa con: pip install open-webui'; exit 1; fi"
    goto :end
)
...
if %errorlevel% equ 0 (
    ...
    set "OPENAI_API_BASE_URLS=http://127.0.0.1:18182/v1;http://127.0.0.1:18187/v1;http://127.0.0.1:18188/v1;http://127.0.0.1:18189/v1;http://127.0.0.1:18185/v1;http://127.0.0.1:18181/v1;http://127.0.0.1:18186/v1;http://127.0.0.1:18184/v1;http://127.0.0.1:18183/v1"
    set "OPENAI_API_KEYS=none;none;none;none;none;none;none;none;none"
